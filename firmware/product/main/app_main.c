/*
 * OpenDeskNode v0.1.0 product bootstrap coordinator.
 *
 * Orchestrates the reference hardware bootstrap (flash/PSRAM report,
 * RLCD/LVGL, BOOT button, Wi-Fi station) and the stock dashboard. The stock
 * task reads the self-hosted LAN Gateway about every
...
{
    /* v0.1.0 captures the button only; settings entry is not implemented. */
...
void app_main(void)
{
    ESP_LOGI(TAG, "OpenDeskNode v0.1.0 boot");
