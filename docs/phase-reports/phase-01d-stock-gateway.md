...
- 目标：QNAP `TerrenceNAS`，x86_64、Container Station 3.1.2、Docker
  27.1.2-qnap8、Compose 2.29.1-qnap2；项目目录为
  `/share/CACHEDEV3_DATA/Container/stock-gateway`。
- 完整 pinned image build 成功，Compose 容器 healthy，LAN 地址
  `http://terrencenas.local:8000/` 与 `http://192.168.31.209:8000/` 可访问；
