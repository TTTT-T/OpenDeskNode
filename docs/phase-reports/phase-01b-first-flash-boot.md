...
- 实际命令：
  ...
  ```bash
  python -m esptool --chip esp32s3 --port /dev/cu.usbmodem3101 --baud 460800 --before default-reset --after hard-reset write-flash --flash-mode dio --flash-freq 80m --flash-size 16MB 0x0 /private/tmp/esp32-s3-rlcd-4.2-build/merged-binary.bin
  ```
